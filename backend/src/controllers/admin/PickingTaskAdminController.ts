...
export class PickingTaskAdminController {
  ...
  async getAllTasks(@Req() req: any, @Res() res: Response, @QueryParams() query: any) {
  ...
  async getTaskById(@Req() req: any, @Res() res: Response, @PathParams("id") id: number) {
  ...
  async createTask(@Req() req: any, @Res() res: Response, @BodyParams() body: PickingTask) {
  ...
  async updateTask(@Req() req: any, @Res() res: Response, @PathParams("id") id: number, @BodyParams() body: PickingTask) {
  ...
  async deleteTask(@Req() req: any, @Res() res: Response, @PathParams("id") id: number) {
